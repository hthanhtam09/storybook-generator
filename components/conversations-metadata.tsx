...
import { generateConversationContent } from "@/lib/conversations-generator";
...
export function ConversationsMetadataForm({
  ...
  const updateMetadata = (
    field: keyof ConversationMetadata,
  ...
  const handleFetchPrompt = async (
    ...
    if (!lessons.length) {
      toast({
        ...
        description: "Please add some lessons before fetching prompt.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      const response = await fetch("/api/conversations/prompt", {
        method: "POST",
        headers: {
  ...
  const handleGenerateSection = async (
    ...
    if (!lessons.length) {
      toast({
        title: "No Lessons Available",
        description: "Please add some lessons before generating content.",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      const result = await generateConversationContent(type, lessons, metadata);
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="e.g., English Conversations for Beginners"
                className="text-sm"
              />
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Explain how readers should use this book. Include tips for learning and getting the most out of the conversations."
                className="min-h-[120px] text-sm"
              />
              <p className="text-xs text-muted-foreground">
